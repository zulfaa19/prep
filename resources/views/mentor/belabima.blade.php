							...
							<div class="dlkio_452">
								<div class="ed_detail_wrap">
									...
									<div class="ed_header_caption">
										<h2 class="ed_title">Namrta K. Mehta</h2>
										<ul>
									...
									<div class="ed_header_short">
										<p>Excepteur sint occaecat cupidatat non proident, deserunt mollit anim id est laborum. accusantium doloremque laudantium,vitae dicta <a href="#" class="theme-cl read-more">Read More..</a>.</p>
                                        <div class="content">
